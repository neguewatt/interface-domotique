		...
		<div data-role="page" data-theme="a" id="imageecran">
			...
			<div id="carregauche">
							...
							<div data-role="popup" id="popupDialog" data-overlay-theme="a" data-theme="c" data-dismissible="false" style="max-width:400px;" class="ui-corner-all">
							    ...
							    <div data-role="content" data-theme="d" class="ui-corner-bottom ui-content">
							        ...
							        <div id ="boutonchiffre">
								        ...
								        <a href="#" data-role="button" id="tailleboutonchiffre" style="float : right; left: 4px" >3</a>
								        <a href="#" data-role="button" id="tailleboutonchiffre" style="float : right; left: 2px" >2</a>
								        <a href="#" data-role="button" id="tailleboutonchiffre" style="float : left" >4</a>
								        <a href="#" data-role="button" id="tailleboutonchiffre" style="float : right; left: 4px" >6</a>
								        <a href="#" data-role="button" id="tailleboutonchiffre" style="float : right; left: 2px" >5</a>
								        <a href="#" data-role="button" id="tailleboutonchiffre" style="float : left" >7</a>
								        <a href="#" data-role="button" id="tailleboutonchiffre" style="float : right; left: 4px" >9</a>
								        <a href="#" data-role="button" id="tailleboutonchiffre" style="float : right; left: 2px" >8</a>
								        <a href="#" data-role="button" id="tailleboutonchiffre" style="float : left">0</a>
								        <a href="#" data-role="button" data-rel="back" style="float : right; height: 15px;width: 54px;left: 2px" >valider</a> 
							   	 	</div>
							        <a href="#" data-role="button" data-rel="back" data-theme="c" class="boutonannuleralarm">annuler</a>
							    </div>
							</div>
						</div>
						<div>
				...
				<div id="carrebasgauche">
					<div>	
						<a href="#popupDialog" data-rel="popup" data-position-to="window"  data-inline="false" data-transition="fade" data-theme="a" data-role="button" id="boutonhautcarrebas">
					...
					<div>
						<input type="checkbox" name="chambre "style="margin-top: 10px">
						<input type="checkbox" name="salon "style="margin-top: 55px">
						<input type="checkbox" name="cuisine "style="margin-top: 98px">
					</div>
					...
					<div class="bascarrevolets">
						<div  data-inline="true">
							<p id="tailletextetitre">Gestion de tous les volets</p>
							<p id="tailletexteperso">Ouverture/Fermeture</p>
							...
							<a href=""><img class="imagefleche" type="image" src="images/flechebas.png"></a>
								...
								<!--     	MODULE DE LA GESTION DES APP EXTERIEUR		 -->

				<div id="carrebasdroite">
					<div>	
						<a href="volets.html" data-role="button" id="boutonhautcarrebas" data-transition="pop">
						<p  class="textboutonhaut">Gestion de l'exterieur</p>
						</a>
					</div>
						<div  data-inline="true">	
							<p id="tailletextetitre">Porte du garage</p>
							<p id="tailletexteperso">Ouverture/Fermeture</p>
							<a href="#"><img class="imageflechehaut" type="image" src="images/flechehaut.png"></a>
							<a href="#"><img class="imagefleche" type="image" src="images/stop.png"></a>
							<a href="#"><img class="imagefleche" type="image" src="images/flechebas.png"></a>
						...
						<div  data-inline="true">
							<p id="tailletextetitre">Portail</p>
							<p id="tailletexteperso">Ouverture/Fermeture</p>
							<a href="#"><img class="imageflechehaut" type="image" src="images/flechehaut.png"></a>
							<a href="#"><img class="imagefleche" type="image" src="images/stop.png"></a>
							<a href="#"><img class="imagefleche" type="image" src="images/flechebas.png"></a>
						...
						<div  data-inline="true">
							<p id="tailletextetitre">Porte d'entrée</p>
							<p id="tailletexteperso">Ouverture/Fermeture</p>
							<a href="#"><img class="imageflechehaut" type="image" src="images/flechehaut.png"></a>
							<a href="#"><img class="imagefleche" type="image" src="images/stop.png"></a>
							<a href="#"><img class="imagefleche" type="image" src="images/flechebas.png"></a>
